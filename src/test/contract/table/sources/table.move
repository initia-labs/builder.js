...
module 0xCAFE::table {
    ...
    #[test(initia_std = @initia_std, s = @0x42)]
    #[expected_failure(abort_code = 196710, location = initia_std::table)]
    ...
    #[test(initia_std = @initia_std, s = @0x42)]
    #[expected_failure(abort_code = 25607, location = initia_std::table)]
    ...
    #[test(initia_std = @initia_std, s = @0x42)]
    #[expected_failure(abort_code = 25863, location = initia_std::table)]
